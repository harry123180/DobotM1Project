...
class ModbusTCPServer:
    def __init__(self):
        ...
        logging.info("Modbus TCP Server 初始化完成")
    ...
    def run(self):
        """主運行方法"""
        try:
            logging.info("=== Modbus TCP Server 啟動 (獨立版本) ===")
